...
- The tool has been modified to a 32-bit version by AmesianX in powerhacker.net.  
- The original developer's github is "https://github.com/JeremyFetiveau/debugging-tools".  
